...
export default function PrivacyPolicy() {
  return (
    <div className="flex flex-col items-stretch justify-between h-[100vh] bg-slate-200 overflow-x-hidden">
      <nav className="flex items-center justify-center h-[75px] bg-slate-950 hover:bg-slate-900 shadow-2xl">
        <div className="w-[80%] flex items-center justify-between">

        {
          /*
          To redirect app/privacypolicy.tsx to app/page.tsx. 
      ...
      <div className="w-full h-auto px-5">
        ...
        <h3 className="text-base font-semibold">Types of Data Collected</h3>
        ...
        <h3 className="text-base font-semibold">Use of Your Personal Data</h3>
        ...
        <h3 className="text-base font-semibold">Retention of Your Personal Data</h3>
        ...
        <h3 className="text-base font-semibold">Transfer of Your Personal Data</h3>
        ...
        <h3 className="text-base font-semibold">Disclosure of Your Personal Data</h3>
        <h4 className="text-sm font-semibold">Business Transactions</h4>
        <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
        <h4>Law enforcement</h4>
        <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
        <h4 className="text-sm font-semibold">Other legal requirements</h4>
