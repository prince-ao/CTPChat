...
function FormattingElement({ children }: Props) {
  return (
    <div>
      <Toggle aria-label="Toggle italic">{children}</Toggle>
    </div>
  );
}
...
export default function Home() {
  ...
  const FormSchema = z.object({
    ...
    chatbox: z.string(), //Fixed Zod error messages popping up underneath Shadcn textarea.
  });
  ...
  return (
    ...
    >
      ...
      <div
        id="infoContainer"
        className="w-[25vw] h-[100vh] bg-blue-900/75 overflow-hidden"
      >
      ...
      <div id="chatContainer" className="w-[50vw] h-[100vh] bg-blue-900/75">
        {" "}
        {/*bg-blue-950*/}
        <div
          id="channelInfoContainer"
          className="flex items-center justify-between w-auto h-[7vh] bg-indigo-900"
        >
